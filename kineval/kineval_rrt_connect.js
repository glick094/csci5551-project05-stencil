...
/**
 * 
 * @param {number[]} q - a robot configuration
 * @returns {Tree} - a tree object with a single vertex for the given configuration
 */
...
/**
 * 
 * @param {Vertex} vertex - a vertex object
 */
 ...
 * @param {number} q1_idx - the index of the first vertex
 * @param {number} q2_idx - the index of the second vertex
 */
...
//////////////////////////////////////////////////
    ...
    // Now its your turn! Write the RRT-Connect functions here
    // similar to how you did in rrt.js
