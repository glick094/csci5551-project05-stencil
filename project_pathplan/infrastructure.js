...
/**
 * 
 * @param {number[]} q - a configuration to test for collision
 * @returns 
 */
...
/**
 * 
 * @param {number[]} q - a configuration to add to the tree
 * @returns {Tree} - a tree object with the new configuration added
 *                Tree object docuemnted in rrt.js
 */
function initRRT(q) {
...
/**
 * 
 * @param {Tree} tree - a tree object to add a vertex to
 * @param {number[]} q - a configuration to add to the tree
 */
...
/**
 * 
 * @param {Tree} tree - a tree object to add an edge to
 * @param {number} q1_idx - the index of the first vertex in the edge
 * @param {number} q2_idx - the index of the second vertex in the edge
 */
